            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form id="addform" role="form" class="form-horizontal m-t">
                    	...
                    	<input id="age" name="age" type="hidden" value="${user.age }">
                    	<input id="type" name="type" type="hidden" value="${user.type }">
                    	<input id="isDel" name="isDel" type="hidden" value="${user.isDel }">
                    	<input id="creator" name="creator" type="hidden" value="${user.creator }">
                    	<input id="createTime" name="createTime" type="hidden" value="${user.createTime }">
                            ...
                            <div class="col-sm-6 col-xs-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7 col-xs-7 col-md-7 col-lg-7">
                                        <input type="text" value="${ user.userCode}" maxlength="16" class="form-control" id="userCode" name="userCode" placeholder="请输入登录名称">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-xs-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7 col-xs-7 col-md-7 col-lg-7">
                                        <input type="text" value="${ user.password}" class="form-control" name="password" placeholder="请输入登录密码">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 col-xs-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7 col-xs-7 col-md-7 col-lg-7">
                                        <input type="text" value="${ user.userName}" class="form-control" name="userName" placeholder="请输入用户名称">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-xs-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7 col-xs-7 col-md-7 col-lg-7">
                                        <input type="text" value="${ user.nickName}" class="form-control" name="nickName" placeholder="请输入用户昵称">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 col-xs-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7 col-xs-7 col-md-7 col-lg-7">
                                        <input type="text" value="${ user.phone}" class="form-control" name="phone" placeholder="请输入电话号码">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-xs-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7 col-xs-7 col-md-7 col-lg-7">
                                        <input type="text" value="${ user.mail}" class="form-control" name="mail" placeholder="请输入联系邮箱">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-xs-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7 col-xs-7 col-md-7 col-lg-7">
                                        <select id="useStatus" name="useStatus" class="chosen-select form-control">
                                            <option value="">全部</option>
...
<!-- 自定义js -->
<script src="<%=path%>/script/web/user/edit.js"></script>
<script type="text/javascript">
	$(function(){
		oldUserCode = '${user.userCode}';
		$("#useStatus").find("option[value='${user.useStatus}']").attr("selected",true);
