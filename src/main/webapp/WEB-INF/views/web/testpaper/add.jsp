                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 col-xs-8 col-md-8 col-lg-8">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7 col-xs-7 col-md-7 col-lg-7">
                                        <textarea class="form-control max" name="tpTitle" placeholder="请输入试卷标题"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-2 col-xs-2 col-md-2 col-lg-2"></div>
                        ...
                        <div class="row" id="sel_up">
                            ...
                            <div class="col-sm-8 col-xs-8 col-md-8 col-lg-8">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7 col-xs-7 col-md-7 col-lg-7">
                                        <input type="text" class="form-control" name="tpRemark" placeholder="请输入试卷备注">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-2 col-xs-2 col-md-2 col-lg-2"></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 col-xs-8 col-md-8 col-lg-8">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7 col-xs-7 col-md-7 col-lg-7">
                                        <select name="isPublish" class="chosen-select form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 col-xs-8 col-md-8 col-lg-8">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7 col-xs-7 col-md-7 col-lg-7">
                                        <select id="tpIsrandom" name="tpIsrandom" class="chosen-select form-control">
                                            <option value=""></option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 col-xs-8 col-md-8 col-lg-8">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7 col-xs-7 col-md-7 col-lg-7">
                                        <input type="text" class="form-control" readonly="readonly" name="tpRandomNumber" placeholder="请输入出题个数">
...
<!-- 自定义js -->
<script src="<%=path%>/script/web/testpaper/add.js"></script>
</body>
</html>