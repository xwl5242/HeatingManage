...
<div class="wrapper wrapper-content animated fadeInRight">
	<input id="modules" type="hidden" value="dic">
    <div class="row">
		<!-- 右侧 -->
                    ...
                    <form id="dics-form" role="form" class="form-horizontal m-t">
                            ...
                            <div class="col-sm-4 col-xs-4 col-md-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7 col-xs-7 col-md-7 col-lg-7">
                                        <input type="text" class="form-control" name="dcName" placeholder="请输字典名称">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4 col-xs-4 col-md-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7 col-xs-7 col-md-7 col-lg-7">
                                        <input type="text" class="form-control" name="dcDesc" placeholder="请输入字典描述">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-8 col-xs-8 col-md-8 col-lg-8  btn-group">
                                <button type="button" class="btn btn-sm btn-info" onclick="addDic()"><i class="fa fa-plus"></i>添加</button>
                                <button type="button" class="btn btn-sm btn-danger" onclick="removeDics()"><i class="fa fa-trash-o"></i>删除</button>
                            </div>
...
<!-- 自定义js -->
<script src="<%=path%>/script/web/dic/list.js"></script>
</body>
</html>