...
function renderSelDivHtml(){
    ...
    '<input type="text" id="qSelItem'+String.fromCharCode((65+inputId))+'" class="form-control"> <span class="input-group-btn">'+
